...
try:
    if Result is True:
        ...
        class PlineOffset(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@折线偏移", "RPP_PlineOffset", """折线段分段偏移，三种不同的偏移模式""", "Scavenger", "Line")
                return instance
        ...
        class Dotted_Line_Conversion(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   ...
                                                                   """曲线集的起点和起点连接，终点和终点连接""", "Scavenger", "Line")
                return instance
        ...
        class PCLINE(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@最近点连线", "RPP_PCLINE", """几何图形到指定线段的最近线段""", "Scavenger", "Line")
                return instance
        ...
        class VectorLineTaking(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@PDWL", "RPP_VectorLineTaking", """点向式绘制直线.""", "Scavenger", "Line")
                return instance
        ...
        class CurveJoin(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@合并曲线", "RPP_Curve_Join", """曲线合并操作（多进程）""", "Scavenger", "Line")
                return instance
        ...
        class ArcPick(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@圆弧拾取", "RPP_ArcPick", """简单圆弧拾取插件，通过参数修改，重建一个新的圆弧""", "Scavenger", "Line")
                return instance
        ...
        class FilterCurve(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@曲线筛选", "RPP_FilterCurve", """通过曲率选择曲线""", "Scavenger", "Line")
                return instance
        ...
        class LineSortByXYZ(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@曲线排序", "RPP_LineSortByXYZ", """曲线列表排序，当轴输入端为空时，按线长排序，输入x，y，z将按照x，y，z的轴坐标进行排序，CP可指定平面""", "Scavenger", "Line")
                return instance
        ...
        class CurveTrim_S(component):
            def __new__(cls):
                instance = Grasshopper.Kernel.GH_Component.__new__(cls,
                                                                   "RPP@Ext_Simplify", "RPP_CurveExtendTrim", """修剪曲线，输入负数时修剪曲线，输入正数时延长曲线.""", "Scavenger", "Line")
                return instance
